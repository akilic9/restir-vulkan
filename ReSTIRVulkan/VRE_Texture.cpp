...
VRE::VRE_Texture::VRE_Texture(VRE_Device& device)
    : mDevice(device)
...
void VRE::VRE_Texture::CreateTexture()
{
...
void VRE::VRE_Texture::CreateImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties)
{
    ...
    mDevice.CreateImageWithInfo(imageInfo, properties, mTextureImage, mTextureImageMemory);
}
