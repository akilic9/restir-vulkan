...
VRE_Device::VRE_Device(VRE_Window &window) : window{window} {
  createInstance();
  setupDebugMessenger();
  createSurface();
  pickPhysicalDevice();
...
void VRE_Device::createSurface() { window.CreateWindowSurface(instance, &surface_); }
...
void VRE_Device::populateDebugMessengerCreateInfo(
...
VkFormat VRE_Device::findSupportedFormat(
...
void VRE_Device::copyBufferToImage(
...
void VRE_Device::createImageWithInfo(
