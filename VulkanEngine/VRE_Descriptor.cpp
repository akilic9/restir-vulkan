...
VRE::VRE_DescriptorSetLayout::VRE_DescriptorSetLayout(VRE_Device& device, const std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding>& bindings)
    : mDevice(device)
    , mBindings(bindings)
{
    std::vector<VkDescriptorSetLayoutBinding> setLayoutBindings{};
    for (const std::pair<const unsigned, VkDescriptorSetLayoutBinding>& binding : mBindings)
    {
