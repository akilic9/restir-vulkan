...
void VRE::VRE_Window::FrameBufferResizedCallback(GLFWwindow* inWindow, int width, int height)
{
    VRE_Window* Window = reinterpret_cast<VRE_Window*>(glfwGetWindowUserPointer(inWindow));
