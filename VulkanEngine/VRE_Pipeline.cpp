...
{
    const std::vector<char>& vertCode = ReadFile(vertShaderPath);
    const std::vector<char>& fragCode = ReadFile(fragShaderPath);
    ...
    const std::vector<VkVertexInputBindingDescription>& bindingDescriptions = configInfo.mBindingDescriptions;
    const std::vector<VkVertexInputAttributeDescription>& attributeDescriptions = configInfo.mAttributeDescriptions;
